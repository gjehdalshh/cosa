...
import com.spring.cosa.user.exception.ValidationGroups.NotBlankGroup;
...
@GroupSequence({DefaultGroup.class, NotBlankGroup.class, NotNullGroup.class, NotEmptyGroup.class, EmailCheckGroup.class,
